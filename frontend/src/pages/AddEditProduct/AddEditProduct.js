				...
				<div className="row">
					<div className="col-md-8 mx-auto">
						...
						<form onSubmit={(event)=>{onSubmit(product,product._id,event)}}>
							...
							<div className="form-floating mb-3">
								<input type="text" className="form-control" id="description" name="description" placeholder="Description" defaultValue={product.hasOwnProperty("title")? product.description: ""} onChange={(event)=>{handleInputChange(event)}}/>
							...
							<div className="form-floating mb-3">
								<input type="text" className="form-control" id="imgUrl" name="imgUrl" placeholder="Image URL" defaultValue={product.hasOwnProperty("title")? product.imgUrl: ""} onChange={(event)=>{handleInputChange(event)}}/>
