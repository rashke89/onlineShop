  ...
  return (
    <form onSubmit={onSubmitForm} method="post">
      ...
      <div className="div-wrap">
        <div className="div-wrap--left w-100">
        ...
        <div className="div-wrap--right w-100">
      ...
      <div className="buttons">
        <button type="button" className="btn btn-login" onClick={loginForm}>
          Go to login
        </button>
        <button className="btn btn-reg">OK</button>
      </div>

      {!isValidForm ? <p>All fields is required!</p> : null}
      {isApiFinish ? <p>You are registered!</p> : null}
      {isApiErr ? (
        <p>ERROR: Something wrong with network, please try later!</p>
      ) : null}
    </form>
  );
}
